      ...
      <div className=''>
        ...
        '>
          ...
          <div className='flex flex-col sm:flex-row gap-4 w-full font-normal text-sm sm:text-md justify-center px-6'>
            <Button styles='py-4 border-none text-white bg-accent px-12 hover:border-white hover:bg-white hover:text-accent duration-300 transition-all ease' text='Записаться!'/>
        ...
        <div className='mx-auto sm:mt-6 overflow-hidden
            max-w-screen-xs-container
            xs:max-w-screen-sm
            sm:max-w-screen-lg 
            xl:max-w-screen-xl'>
